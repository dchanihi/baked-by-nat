...
const Index = () => {
  ...
  const scrollToBakes = (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    bakesSection?.scrollIntoView({ behavior: 'smooth' });
  };
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 order-2 md:order-1">
              ...
              <p className="text-base md:text-lg font-body text-foreground leading-relaxed">
                i'm a home baker who loves creating cute, cozy desserts that make people smile. 
                here you'll find photos of my latest bakes, sweet inspiration, and lots of pastel-colored treats. 
                whether it's fluffy cupcakes, buttery cookies, or dreamy cakes, everything is baked with love ♡
              </p>
              <Button 
                onClick={scrollToBakes}
                className="bg-pink-soft hover:bg-pink-medium text-primary-foreground font-body font-medium px-8 py-6 text-base rounded-full shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300"
              >
            ...
            <div className="order-1 md:order-2">
              <div className="rounded-3xl overflow-hidden shadow-2xl border-4 border-pink-soft/20">
                <img
                  src={heroImage}
                  alt="Cozy baking scene with cute pastries"
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="text-center">
              <Button 
                asChild
                variant="outline"
                className="border-2 border-pink-soft hover:bg-pink-soft hover:text-primary-foreground font-body font-medium px-8 py-6 text-base rounded-full shadow-md hover:shadow-lg transition-all duration-300"
              >
                <Link to="/bakes">
                  see all bakes →
                </Link>
